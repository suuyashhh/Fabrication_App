...
namespace WebApplication1
{
    public partial class Fab_Admin_Create_Salaryslip : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("Fab_Admin_Login.aspx?type=Fab_Admin_Create_Salaryslip");
            }
            if (!IsPostBack)
            {
                BindHelperDropdown();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            this.ClientScript.RegisterStartupScript(this.GetType(), "SweetAlert", "swal('Salary slip saved successfully.','','success');", true);
