<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Fab_Helper_SalaryHistory.aspx.cs" Inherits="WebApplication1.Fab_Helper_SalaryHistory" %>
...
<head runat="server">
    ...
    <title>Helper Salary History Management</title>
    ...
    <form id="form" runat="server">
        <div class="container-fluid">
            ...
            <div class="header">
                ...
                <h1>Helper Salary Histoy Management</h1>
            </div>
     ...
     <asp:GridView runat="server" ID="gridhelpSalaryHistory" DataKeyNames="Slip_id" AutoGenerateColumns="false" CssClass="table table-striped table-bordered " Style="border: 1px solid #10a37f; border-radius: 6px; margin-top: 20px">
         <Columns>
