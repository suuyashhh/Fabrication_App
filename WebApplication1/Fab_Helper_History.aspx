<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Fab_Helper_History.aspx.cs" Inherits="WebApplication1.Fab_Helper_History" %>
...
<head runat="server">
    ...
    <title>Helper Salary Slip History</title>
    ...
    <form id="form1" runat="server">
        <div class="container-fluid">
            ...
            <div class="header d-flex align-items-center">
                ...
                <h1>Helper Salary Slip History</h1>
            </div>
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        ...
                                        <strong><asp:Label runat="server" ID="LblName"></asp:Label></strong><br />
                                    </div>
                                    <div class="col-md-4">
      ...
      window.onpopstate = function (event) {
          window.location.href = 'Fab_Helper_SalaryHistory.aspx';
      };
